...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml" lang="en">
   <head>
      ...
      <meta name="twitter:title" content="Test email">
      ...
      <meta property="og:url" content="https://marketing.direktiv.io/-temporary-slug-17f56958-125b-40e1-b06c-a61bbd2430a5">
      ...
      <style type="text/css">
         ...
         body[data-outlook-cycle] .hs_rss_email_entries_table img {
         height: auto !important;
         width: 100% !important
         }
         body[data-outlook-cycle] .hs_padded {
         padding-left: 20px !important;
         padding-right: 20px !important
         }
                                             ...
                                             <tbody>
                                                <tr>
                                                   <td align="center" valign="top" style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; color:#23496d; word-break:break-word; text-align:center; padding:10px 20px; font-size:0px">
                                                      <img alt="direktiv-logo.png" src="https://github.com/direktiv/direktiv/raw/main/assets/images/direktiv-logo.png" style="outline:none; text-decoration:none; -ms-interpolation-mode:bicubic; max-width:100%; font-size:16px" width="163" align="middle">
                                                   </td>
                                                </tr>
                                             </tbody>
                                          </table>
                                                ...
                                                <tr>
                                                   <td class="hs_padded" style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; font-size:15px; color:#23496d; word-break:break-word; padding:10px 20px">
                                                      <div id="hs_cos_wrapper_module-1-0-0" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_module" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="module">
                                                         <div id="hs_cos_wrapper_module-1-0-0_" class="hs_cos_wrapper hs_cos_wrapper_widget hs_cos_wrapper_type_rich_text" style="color: inherit; font-size: inherit; line-height: inherit;" data-hs-cos-general-type="widget" data-hs-cos-type="rich_text">
                                                            <p style="mso-line-height-rule:exactly; line-height:175%; margin-bottom:10px">We noticed that some of the volumes on your AWS environment has remained undeleted. The following volumes have been identified as possible candidates for deletion:</p>
                                                            <p style="mso-line-height-rule:exactly; line-height:175%; margin-bottom:10px">&nbsp;</p>
                                                            <table align="center" width="500" style="text-align:left;">
                                                                <tr>
                                                                    <th>Volume </th>
                                                                    <th>IdRegion</th>
                                                                    <th>Zone</th>
                                                            ...
                                                            <p style="mso-line-height-rule:exactly; line-height:175%; margin-bottom:10px">&nbsp;</p>
                                                            <p style="mso-line-height-rule:exactly; line-height:175%; margin-bottom:10px">The Cloud Cost Recovery team have raised the following ServiceNow Change Request for your review and approval. From the Change Request you are able to select the appropriate volumes for deletion. Once selected, please process the Change Request through the Change Approval Board process and during the "Implement" state the volumes will automatically be deleted.</p>
                                                            <p style="mso-line-height-rule:exactly; line-height:175%; margin-bottom:10px">&nbsp;</p>
                                                            <a href="{{url}}" style="mso-line-height-rule:exactly; color:#00a4bd">{{change}}</a>
                                                            <p style="mso-line-height-rule:exactly; line-height:175%; margin-bottom:10px">&nbsp;</p>
                                                            <p style="mso-line-height-rule:exactly; line-height:175%; margin-bottom:10px">Don't worry - we will also update the Change Request with the volumes deleted (and not deleted)</p>
                                                            <p style="mso-line-height-rule:exactly; line-height:175%; margin-bottom:10px">Thanks, <br>
                                                               <a href="/cdn-cgi/l/email-protection#086b64677d6c6b677b7c7a6d6b677e6d7a7148786971786964266b67656b64677d6c6b677b7c7a6d6b677e6d7a7148786971786964266b6765" rel="noopener" style="mso-line-height-rule:exactly; color:#00a4bd" data-hs-link-id="0" target="_blank">Direktiv Cloud Cost Recovery Team</a>
                                                            </p>
                                                         </div>
                                                      </div>
                                                   </td>
                                                   ...
                                                   <tbody>
                                                      <tr>
                                                         <td align="center" valign="top" style="border-collapse:collapse; mso-line-height-rule:exactly; font-family:Arial, sans-serif; font-size:15px; color:#23496d; word-break:break-word; text-align:center; margin-bottom:0; line-height:135%; padding:10px 20px">
                                                            <p style="mso-line-height-rule:exactly">This email was delivered by the Direktiv Cloud Cost Recovery system.
                                                            </p>
                                                         </td>
                                                      </tr>
                                                   </tbody>
